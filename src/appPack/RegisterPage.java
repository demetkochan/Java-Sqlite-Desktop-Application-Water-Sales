...
public class RegisterPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1008, 595));
        setResizable(false);
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/search_icon.png"))); // NOI18N
        ...
        jPanel2.setBounds(12, 13, 460, 80);
        ...
        jButton6.setText("Bugünün Siparişleri");
        ...
        jPanel1.setBounds(492, 13, 489, 82);
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/addCustomer_icon.png"))); // NOI18N
        ...
        jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/editCustomer_icon.png"))); // NOI18N
        ...
        jButton9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/deleteCustomer_icon.png"))); // NOI18N
        ...
        jPanel3.setBounds(12, 102, 462, 383);
        ...
        jButton11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/newOrder_icon.png"))); // NOI18N
        ...
        jButton12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/delivery_icon.png"))); // NOI18N
        ...
        jButton13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/delivered_icon.png"))); // NOI18N
        ...
        jPanel4.setBounds(492, 102, 489, 383);
        ...
        jButton14.setBounds(870, 490, 110, 50);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/background_1_1008x595.jpg"))); // NOI18N
        getContentPane().add(jLabel6);
        jLabel6.setBounds(0, -14, 1020, 590);

        setSize(new java.awt.Dimension(1012, 603));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if( name.equals("") || surname.equals("")){ //boş olup olmadıkları kontrol edilir.
    ...
    private void tbl_customerMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_customerMouseReleased
        ...
        String address = (String) tbl_customer.getValueAt(row, 4);
         ...
         updatepage = new UpdatePage(name, surname, number, address);
         orderpage = new OrderPage(name,surname,address);
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        if(customerid>0){
            ...
            DB db = new DB();
            int status = db.orderUpdate(customerid);
            db.close();
            refreshOrders();
            customerid = 0;
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        if(customerid>0){
            DB db = new DB();
            int status = db.orderUpdate2(customerid);
            db.close();
            refreshOrders();
            customerid = 0;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(customerid>0){
            ...
            if(select == 0){
                DB db = new DB();
                int status = db.ordersDelete(customerid);
                db.close();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        int select = JOptionPane.showConfirmDialog(rootPane, "Tüm Siparişleri Silmek istediğinizden emin misiniz?", "Silme İşlemi", JOptionPane.YES_NO_OPTION);
        
        if(select == 0){
            DB db = new DB();
            int status = db.allOrdersDelete();
            db.close();
            refreshOrders();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
          DB db = new DB();
          tbl_orders.setModel(db.listOrder());
          db.close();
